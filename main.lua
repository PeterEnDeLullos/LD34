...
function love.load()
 ...
 -- Music.theme:enqueue("music/theme_loop.wav")
  ...
  --let's create a ball
  --column, ball
  gamestate.WM.newMiniPart("levels/start.lua",1,1)
  gamestate.WM.newMiniPart("levels/2.lua", 2, 1)
  gamestate.WM.newMiniPart("levels/3.lua", 2, 2)
  gamestate.WM.newMiniPart("levels/koffers.lua", 1, 2)
